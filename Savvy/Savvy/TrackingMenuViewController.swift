...
class trackingMenuCell: UITableViewCell {
...
class trackingMenuViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    @objc var functions: [String] = ["Health","Mood"]
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        var logging_parameters:[String:AnyObject] = ["id":uid as AnyObject,"page":"trackingMenu"as AnyObject,"action":"appear" as AnyObject,"json":[:] as AnyObject]
    ...
    override func viewDidDisappear(_ animated: Bool) {
        ...
        var logging_parameters:[String:AnyObject] = ["id":uid as AnyObject,"page":"trackingMenu"as AnyObject,"action":"disappear" as AnyObject,"json":[:] as AnyObject]
        self.remoteLogging(logging_parameters )
        }
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            let cell = self.tableView.dequeueReusableCell(withIdentifier: "trackMenuCell", for: indexPath) as! trackingMenuCell
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
       ...
       if(segue.identifier == "trackingMenuToView") {

           let nextViewController = (segue.destination as! trackingViewController)
           nextViewController.type = self.segueType
           }}
   func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
    self.segueType = indexPath.row
        self.performSegue(withIdentifier: "trackingMenuToView", sender: self)
